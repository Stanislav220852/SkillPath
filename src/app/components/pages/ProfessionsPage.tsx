...
const themeGradient = "from-[var(--tp)] via-[var(--tp-dark)] to-[var(--ta)]";
const themeText = "text-[var(--tp-dark)] dark:text-[var(--tp)]";
...
To accomplish this, they use game engines, programming languages, 3D graphics tools, and modern development technologies. Game Developers help create products enjoyed by millions of players around the world every day.`,
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className={`${glassCard} p-0 overflow-hidden relative aspect-video group cursor-pointer`}
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${themeGradient} opacity-30`} />
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 md:gap-4">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-white/90 dark:bg-white/95 flex items-center justify-center shadow-2xl group-hover:shadow-[var(--tp)]/50 transition-shadow"
                  >
              ...
              <div className={`${glassCard} p-6 md:p-8`}>
                <div className="flex items-start gap-4 md:gap-5 mb-5">
                  <div className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br ${themeGradient} flex items-center justify-center shadow-lg flex-shrink-0`}>
  ...
  {active.desc}
              ...
              <div className={`${glassCard} p-6 md:p-8`}>
                ...
                <div className="relative h-3 bg-stone-200 dark:bg-white/10 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className={`h-full bg-gradient-to-r ${themeGradient} rounded-full`}
                  />
                </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={goToRoadmap}
                className={`w-full p-5 md:p-6 rounded-3xl bg-gradient-to-r ${themeGradient} text-white font-black text-base md:text-lg flex items-center justify-center gap-3 shadow-xl hover:shadow-2xl transition-shadow`}
              >
