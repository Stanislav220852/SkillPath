...
const buildProjects = (lang: "EN" | "RU") => [
  {
    ...
    role: "Frontend",
    color: "blue",
    gradient: "from-[#8AA8FF] via-[#002A54] to-[#002A54]",
    views: "2.4k",
    likes: 187,
  ...
  },
  {
    ...
    role: "AI/ML",
    color: "orange",
    gradient: "from-[#FF9800] via-[#e68900] to-[#e68900]",
    views: "5.1k",
    likes: 412,
  ...
  },
  {
    ...
    role: "Cybersec",
    color: "navy",
    gradient: "from-[#002A54] via-[#001a3a] to-[#00000F]",
    views: "1.8k",
    likes: 234,
  ...
  },
  {
    ...
    role: "Data",
    color: "blue2",
    gradient: "from-[#8AA8FF] via-[#002A54] to-[#8AA8FF]",
    views: "3.2k",
    likes: 298,
  ...
  },
  {
    ...
    role: "Frontend",
    color: "blue3",
    gradient: "from-[#002A54] via-[#8AA8FF] to-[#002A54]",
    views: "8.7k",
    likes: 612,
  ...
  },
  {
    ...
    role: "AI/ML",
    color: "orange2",
    gradient: "from-[#FF9800] via-[#e68900] to-[#FF9800]",
    views: "12.3k",
    likes: 891,
...
const ProjectCard = ({ p, lang }: { p: any; lang: "EN" | "RU" }) => (
  <motion.div
    ...
    whileHover={{ y: -8 }}
    className="group relative rounded-3xl overflow-hidden bg-white dark:bg-[#0d0e12] border border-black/5 dark:border-white/[0.07] shadow-lg hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)] transition-shadow duration-500 cursor-pointer h-full"
  >
    ...
    <div className={`relative h-48 md:h-56 bg-gradient-to-br ${p.gradient} overflow-hidden`}>
      ...
      <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
        ...
        <div className="flex items-center gap-1.5 text-white">
          <Heart className="w-4 h-4 fill-[#FF9800] text-[#FF9800]" />
          <span className="text-sm font-bold">{p.likes}</span>
        </div>
        <button className="ml-2 px-3 py-1.5 rounded-full bg-white text-[#00000F] text-xs font-bold flex items-center gap-1.5 hover:scale-105 transition-transform">
    ...
    {/* card body */}
    <div className="p-5">
      <h3 className="text-lg font-black text-[#00000F] dark:text-white mb-1">{p.title}</h3>
      <p className="text-xs text-[#002A54]/50 dark:text-white/50 mb-3">
        by {p.author}
      </p>
      <div className="flex flex-wrap gap-1.5">
        {p.tech.map((tch: string) => (
          <span key={tch} className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-stone-100 dark:bg-white/5 text-[#002A54]/60 dark:text-white/70 border border-stone-200 dark:border-white/10">
            {tch}
          </span>
        ))}
      </div>
...
export const ProjectsShowcase = () => {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#8AA8FF]/5 dark:bg-[#8AA8FF]/10 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#FF9800]/5 dark:bg-[#FF9800]/10 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-10 md:mb-14">
          ...
          <p className="text-[#002A54]/60 dark:text-white/60 max-w-xl mx-auto">
            {lang === "RU"
        ...
        <div className="text-center mt-10 md:mt-12">
          <p className="text-[#002A54]/50 dark:text-white/50 mb-4 text-sm">
            {lang === "RU"
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-3 rounded-full bg-gradient-to-r from-[#8AA8FF] via-[#002A54] to-[#FF9800] text-white font-bold text-sm inline-flex items-center gap-2 shadow-lg shadow-[#8AA8FF]/30"
          >
