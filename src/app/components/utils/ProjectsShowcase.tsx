      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-14">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white mb-4"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((p, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative rounded-3xl overflow-hidden bg-white dark:bg-slate-900 border border-black/5 dark:border-white/10 shadow-lg hover:shadow-2xl transition-shadow duration-500 cursor-pointer"
            >
              ...
              <div className="p-5">
                ...
                <p className="text-xs text-slate-500 dark:text-white/50 mb-3">
                  {lang === "RU" ? "by " : "by "}{p.author}
                </p>
                <div className="flex flex-wrap gap-1.5">
                  {p.tech.map((t) => (
                    <span key={t} className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-white/70 border border-slate-200 dark:border-white/10">
                      {t}
                    </span>
                  ))}
                </div>
