  ...
  return (
    <motion.div
      ...
      className={`relative rounded-3xl p-8 flex flex-col h-full ${
        plan.popular
          ? "bg-gradient-to-br from-slate-900 to-slate-800 dark:from-cyan-500 dark:to-blue-600 border-2 border-cyan-500 dark:border-white/20 shadow-2xl shadow-cyan-500/30 lg:scale-105 z-10"
