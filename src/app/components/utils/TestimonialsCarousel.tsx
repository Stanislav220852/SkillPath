        ...
        <div className="max-w-3xl mx-auto relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-white/60 dark:bg-white/5 backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-xl relative"
            >
              <Quote className="absolute top-6 right-6 w-12 h-12 text-cyan-500/20 dark:text-cyan-400/20" />

              <p className="text-lg md:text-xl text-slate-700 dark:text-white/80 leading-relaxed mb-8">
                "{current.text}"
              </p>

              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${avatarGradients[idx % avatarGradients.length]} flex items-center justify-center text-white font-black text-lg shadow-lg`}>
                    {initials}
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3 bg-gradient-to-r from-green-500/10 to-emerald-500/10 dark:from-green-500/20 dark:to-emerald-500/20 px-4 py-2 rounded-2xl border border-green-500/20">
